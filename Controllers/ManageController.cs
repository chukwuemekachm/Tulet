...
using Tulet.Models.ManageViewModels;
...
namespace Tulet.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Profile()
        {
            ...
            var model = new UserViewModel { StatusMessage = StatusMessage, PhotoUrl = "/images/avatar_default.png" };
            return View(model);
        }
        ...
        public async Task<IActionResult> Post() 
        {
            ...
            { 
                StatusMessage = StatusMessage,
                Categories = cmd.Category.Select(x => new SelectListItem{ Value = x.Name, Text = x.Name }).ToList(),
                Types = cmd.Type.Select(x => new SelectListItem{ Value = x.Name, Text = x.Name }).ToList()
            };
            return View(model);
        } 
